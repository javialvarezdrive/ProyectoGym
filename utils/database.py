...
# Inicializar el cliente con Supabase
supabase = create_client(SUPABASE_URL, SUPABASE_KEY)

# Funciones para usuarios
def get_usuarios(activo=True):
    """Obtiene usuarios según su estado (activo/inactivo) o todos si activo es None."""
...
# Funciones para tipos y actividades
...
def get_actividades(filtros=None):
    ...
    if filtros:
        ...
        # Para filtrar campos anidados usamos la sintaxis JSON (->>)
